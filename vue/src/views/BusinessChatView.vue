...
.session-list {
  ...
  scrollbar-color: rgba(101, 116, 139, 0.35) transparent;
}
...
.session-list::-webkit-scrollbar-thumb {
  background: rgba(101, 116, 139, 0.35);
  border-radius: 999px;
}

.session-list::-webkit-scrollbar-thumb:hover {
  background: rgba(101, 116, 139, 0.5);
}
...
.notice-error {
  ...
  border-color: rgba(185, 64, 48, 0.14);
...
.delete-button {
  ...
  border-color: rgba(185, 64, 48, 0.1);
  color: var(--color-danger);
  flex: none;
}
