...
function recommendationText(item) {
  ...
  return '当前样本已经接近可上线验证状态，下一步重点看不同问题类型下是否还能持续稳定。'
}
...
.highlight-card {
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.07), rgba(239, 123, 57, 0.07));
}
...
.doc-timeline-top {
  border-color: rgba(67, 56, 202, 0.2);
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.05), rgba(255, 255, 255, 0.9));
}
...
.health-fill-neutral { background: linear-gradient(90deg, #4338ca, #0f766e); }
