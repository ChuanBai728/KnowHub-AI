...
.badge-failed { background: rgba(185, 64, 48, 0.1); color: var(--color-danger); }
.badge-stopped { background: rgba(180, 98, 26, 0.1); color: var(--color-warning); }
...
.chip-failed { background: rgba(185, 64, 48, 0.1); color: var(--color-danger); }
.chip-warning { background: rgba(180, 98, 26, 0.1); color: var(--color-warning); }
...
.error-notice {
  ...
  background: rgba(185, 64, 48, 0.06);
  border: 1px solid rgba(185, 64, 48, 0.1);
}
