    ...
    <div class="top-grid">
      ...
      <article class="panel-card tips-card">
        ...
        <ul class="tips-list">
          ...
          <li>索引构建过程会保留完整阶段轨迹，方便任务排查和运行复盘。</li>
        </ul>
      </article>
    </div>
...
.pipeline-headline-parent {
  border-bottom-color: rgba(67, 56, 202, 0.22);
}
...
.strategy-status-step-current {
  ...
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.06), rgba(255, 255, 255, 0.96));
}
...
.selected-flow-board-parent {
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.05), rgba(67, 56, 202, 0.015));
}
...
.timeline-list-parent .timeline-item {
  ...
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.04), rgba(255, 255, 255, 0.96));
}
...
.selected-flow-board-parent .selected-flow-card {
  ...
  box-shadow: 0 12px 24px rgba(67, 56, 202, 0.07);
}
...
.strategy-picker-parent .strategy-chip.active {
  ...
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.14), rgba(67, 56, 202, 0.04));
  box-shadow: 0 4px 16px rgba(67, 56, 202, 0.16);
}
