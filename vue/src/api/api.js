...
const ADMIN_TOKEN_KEY = 'knowhub-admin-token'
const ADMIN_USER_KEY = 'knowhub-admin-user'
...
function buildApiUrl(path) {
  const versionedPath = withApiVersion(path)
  return API_BASE_URL ? new URL(versionedPath, API_BASE_URL).toString() : versionedPath
}
...
function withApiVersion(path) {
  if (!path || /^https?:\/\//i.test(path) || path.startsWith(API_VERSION_PREFIX)) {
    return path
  }
  if (path.startsWith('/api/')) {
    return `${API_VERSION_PREFIX}${path.slice('/api'.length)}`
  }
...
export const chatApi = {
  listKnowledgeDocumentOptions() {
    return requestApiEnvelope(apiPath('/chat/document/options'), {
      method: 'POST',
      body: {}
    })
  },
  ...
  listSessionsPage(query = {}) {
    ...
    return requestApiEnvelope(apiPath('/chat/session/list'), {
      method: 'POST',
      body: {
  ...
  getSession(conversationId) {
    ...
    return requestApiEnvelope(apiPath('/chat/session/detail'), {
      method: 'POST',
      body: {
        conversationId
      }
  ...
  getExchangeDetail(conversationId, exchangeId) {
    return requestApiEnvelope(apiPath('/chat/exchange/detail'), {
      method: 'POST',
      body: {
        conversationId,
  ...
  deleteSession(conversationId) {
    ...
    return requestApiEnvelope(apiPath('/chat/session/reset'), {
      method: 'POST',
      body: {
        conversationId
      }
  ...
  stopSession(conversationId) {
    ...
    return requestApiEnvelope(apiPath('/chat/session/stop'), {
      method: 'POST',
      body: {
        conversationId
      }
  ...
  rebuildConversationSummary(conversationId) {
    // 管理侧允许手动触发长期摘要重建，
    // 这样调试排查时，不必等下一轮对话触发”顺手更新”。
    return requestApiEnvelope(apiPath('/chat/session/summary/rebuild'), {
      method: 'POST',
      body: {
        conversationId
      }
  ...
  getRetrievalResults(conversationId, exchangeId) {
    return requestApiEnvelope(apiPath('/chat/exchange/retrieval/results'), {
      method: 'POST',
      body: {
        conversationId,
        exchangeId: String(exchangeId)
  ...
  getChannelExecutions(conversationId, exchangeId) {
    return requestApiEnvelope(apiPath('/chat/exchange/channel/executions'), {
      method: 'POST',
      body: {
        conversationId,
        exchangeId: String(exchangeId)
  ...
  getStageBenchmarks() {
    return requestApiEnvelope(apiPath('/chat/stage/benchmarks'), {
      method: 'POST',
      body: {}
    })
  },
  ...
  openStream(payload, handlers = {}) {
    ...
    const done = (async () => {
      const response = await fetch(buildApiUrl(apiPath('/chat/stream')), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
export const adminAuthApi = {
  login(payload) {
    return requestApiEnvelope(apiPath('/admin/auth/login'), {
      method: 'POST',
      body: payload
    })
  },
  ...
  logout() {
    return requestApiEnvelope(apiPath('/admin/auth/logout'), {
      method: 'POST',
      body: {}
    })
  },
  ...
  currentUser() {
    return requestJson(apiPath('/admin/auth/me'))
...
export const manageApi = {
  uploadDocument({ file, documentName, operatorId, knowledgeScopeCode, knowledgeScopeName, businessCategory, documentTags }) {
    ...
    return requestMultipartApiEnvelope(apiPath('/manage/document/upload'), formData)
  },

  queryDocumentPage(payload) {
    return requestApiEnvelope(apiPath('/manage/document/page/query'), {
      method: 'POST',
  ...
  queryDocumentDetail(documentId) {
    return requestApiEnvelope(apiPath('/manage/document/detail/query'), {
      method: 'POST',
  ...
  deleteDocument(payload) {
    return requestApiEnvelope(apiPath('/manage/document/delete'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryStrategyPlan(documentId) {
    return requestApiEnvelope(apiPath('/manage/document/strategy/plan/query'), {
      method: 'POST',
      body: stringifyManageValue({
        documentId
      })
  ...
  confirmStrategy(payload) {
    return requestApiEnvelope(apiPath('/manage/document/strategy/confirm'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  buildIndex(payload) {
    return requestApiEnvelope(apiPath('/manage/document/index/build'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryDocumentChunks(payload) {
    return requestApiEnvelope(apiPath('/manage/document/chunk/query'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryDocumentChunkDetail(payload) {
    return requestApiEnvelope(apiPath('/manage/document/chunk/detail/query'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryTaskLogs(payload) {
    return requestApiEnvelope(apiPath('/manage/document/task/log/query'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  saveKnowledgeScope(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/scope/save'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  deleteKnowledgeScope(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/scope/delete'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  listKnowledgeScopes() {
    return requestApiEnvelope(apiPath('/manage/knowledge/scope/list'), {
      method: 'POST',
      body: {}
    })
  },
  ...
  saveKnowledgeTopic(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/save'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  deleteKnowledgeTopic(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/delete'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  listKnowledgeTopics(payload = {}) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/list'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryDocumentProfile(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/document/profile/detail'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  regenerateDocumentProfile(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/document/profile/regenerate'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  batchRegenerateDocumentProfiles(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/document/profile/batch/regenerate'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  listTopicDocuments(payload = {}) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/document/list'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  saveTopicDocumentRelation(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/document/save'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  removeTopicDocumentRelation(payload) {
    return requestApiEnvelope(apiPath('/manage/knowledge/topic/document/remove'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  },
  ...
  queryKnowledgeRouteTracePage(payload = {}) {
    return requestApiEnvelope(apiPath('/manage/knowledge/route/trace/page/query'), {
      method: 'POST',
      body: stringifyManageValue(payload)
    })
  }
