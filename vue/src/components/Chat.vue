...
.avatar {
  ...
  background: linear-gradient(135deg, rgba(67, 56, 202, 0.14), rgba(224, 96, 64, 0.1));
...
.message-error {
  border: 1px solid rgba(185, 64, 48, 0.14);
...
.route-status-badge-success {
  background: rgba(22, 118, 94, 0.1);
  color: var(--color-success);
}

.route-status-badge-warning {
  background: rgba(180, 98, 26, 0.12);
...
.markdown-body :deep(a) {
  ...
  text-decoration-color: rgba(67, 56, 202, 0.22);
