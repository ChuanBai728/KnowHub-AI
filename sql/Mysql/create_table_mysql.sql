CREATE TABLE IF NOT EXISTS knowhub_chat_dialogue (
    ...
    PRIMARY KEY (id),
    KEY idx_knowhub_chat_dialogue_code_status (dialogue_code, status),
    KEY idx_knowhub_chat_dialogue_stage_status (dialogue_stage, status),
    KEY idx_knowhub_chat_dialogue_edit_time (edit_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务对话归档主表';

CREATE TABLE IF NOT EXISTS knowhub_chat_exchange (
    id BIGINT NOT NULL COMMENT '主键id',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_knowhub_chat_exchange_dialogue_status (dialogue_code, status),
    KEY idx_knowhub_chat_exchange_state_status (exchange_state, status),
    KEY idx_knowhub_chat_exchange_create_time (create_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务对话轮次归档表';

CREATE TABLE IF NOT EXISTS knowhub_chat_memory_summary (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) NOT NULL COMMENT '所属业务会话编号',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    UNIQUE KEY uk_knowhub_chat_memory_summary_dialogue (dialogue_code),
    KEY idx_knowhub_chat_memory_summary_cover (covered_exchange_id),
    KEY idx_knowhub_chat_memory_summary_edit_time (edit_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务对话长期记忆摘要快照表';

CREATE TABLE IF NOT EXISTS knowhub_chat_exchange_trace_stage (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) NOT NULL COMMENT '所属业务会话编号',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_knowhub_chat_trace_exchange (exchange_id, stage_order),
    KEY idx_knowhub_chat_trace_dialogue (dialogue_code, exchange_id),
    KEY idx_knowhub_chat_trace_trace_id (trace_id),
    KEY idx_knowhub_chat_trace_stage_code (stage_code)
...
CREATE TABLE IF NOT EXISTS `knowhub_document` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_strategy_plan` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_strategy_step` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_task` (
   `id` bigint NOT NULL COMMENT '主键id',
   `document_id` bigint NOT NULL COMMENT '文档id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_task_log` (
   `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_structure_node` (
   `id` bigint NOT NULL COMMENT '主键id',
   `document_id` bigint NOT NULL COMMENT '文档id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_parent_block` (
   `id` bigint NOT NULL COMMENT '主键id',
   `document_id` bigint NOT NULL COMMENT '文档id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_chunk` (
    `id` bigint NOT NULL COMMENT '主键id',
    `document_id` bigint NOT NULL COMMENT '文档id',
    `task_id` bigint NOT NULL COMMENT '索引任务id',
    `plan_id` bigint DEFAULT NULL COMMENT '策略方案id',
...
CREATE TABLE IF NOT EXISTS `knowhub_knowledge_scope_node` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_knowledge_topic_node` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `knowhub_document_profile` (
    `id` bigint NOT NULL COMMENT '主键id',
    `document_id` bigint NOT NULL COMMENT '文档id',
...
CREATE TABLE IF NOT EXISTS `knowhub_topic_document_relation` (
    `id` bigint NOT NULL COMMENT '主键id',
    `topic_code` varchar(64) NOT NULL COMMENT '主题编码',
    `document_id` bigint NOT NULL COMMENT '文档id',
...
CREATE TABLE IF NOT EXISTS `knowhub_knowledge_route_trace` (
    `id` bigint NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS knowhub_chat_retrieval_result (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) NOT NULL COMMENT '所属业务会话编号',
    exchange_id BIGINT NOT NULL COMMENT '所属轮次id',
    trace_id VARCHAR(64) NOT NULL COMMENT '本轮执行trace id',
...
CREATE TABLE IF NOT EXISTS knowhub_chat_channel_execution (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) NOT NULL COMMENT '所属业务会话编号',
    exchange_id BIGINT NOT NULL COMMENT '所属轮次id',
    trace_id VARCHAR(64) NOT NULL COMMENT '本轮执行trace id',
...
CREATE TABLE IF NOT EXISTS knowhub_chat_stage_benchmark (
    id BIGINT NOT NULL COMMENT '主键id',
    stage_code VARCHAR(64) NOT NULL COMMENT '阶段编码',
